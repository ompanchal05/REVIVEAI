...
export const Sidebar: React.FC<SidebarProps> = ({
  ...
  return (
    <>
      ...
      <aside className="hidden md:flex w-64 bg-[#0F0F0F] border-r border-[#2A2A2A] flex-col shrink-0 min-h-[calc(100vh-4.5rem)]">
        {sidebarContent}
      </aside>
      ...
      {isOpenMobile && (
        <div className="fixed inset-0 z-40 md:hidden flex">
          ...
          />
          <div className="relative w-64 max-w-[80vw] bg-[#0F0F0F] border-r border-[#2A2A2A] h-full z-50 flex flex-col shadow-2xl animate-in slide-in-from-left duration-200">
            {sidebarContent}
          </div>
        </div>
      )}
